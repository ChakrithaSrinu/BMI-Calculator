...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label2.config(text='overrweight!')
...
def slider_changed1(event):
    Weight.set(get_current_value1())



style1 = ttk.Style()
style1.configure('TScale',background='white')
slider1 = ttk.Scale(root, from_=0, to=200, orient='horizontal',style='TScale',
                   command=slider_changed1, variable = current_value1)
slider1.place(x=300,y=250)
...
label1 = Label(root, font='arial 60 bold',bg = 'lightblue',fg='#3b3a3a')
